...
- [ ] Paste Instructions from `app-custom-gpt/instructions/instructions.md`
...
- [ ] Upload Knowledge files `01`–`08` from `app-custom-gpt/knowledge/`
- [ ] Capabilities: Web Search **OFF**, Image Generation **OFF**, Code Interpreter / Data Analysis **ON**
- [ ] Configure Actions — import `app-custom-gpt/actions/openapi.yaml`
